...
const RULES = {
  refund: [
    ...
    'chargeback', 'charge back', 'full refund', 'partial refund',
    // Dutch
  ...
  replacement: [
    ...
    'send another', 'send me a new', 'want a new', 'get a new', 'substitute',
    // Dutch
  ...
  returns: [
    ...
    'cancel order', 'cancel my order', 'want to return',
    // Dutch
  ...
  damage: [
    ...
    'scratched', 'bent', 'shattered', 'destroyed', 'not working',
    'doesnt work', 'stopped working', 'fell apart', 'arrived broken',
    // Dutch
